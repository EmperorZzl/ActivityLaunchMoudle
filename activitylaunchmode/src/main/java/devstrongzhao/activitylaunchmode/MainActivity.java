    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.standard_btn:
                ...
                MainActivity.this.startActivity(standardIntent);
                break;
            case R.id.single_top_btn:
                Intent singleTopIntent = new Intent(MainActivity.this, ActivitySingleTop.class);
                MainActivity.this.startActivity(singleTopIntent);
                break;
            case R.id.single_task_btn:
                Intent singleTaskIntent = new Intent(MainActivity.this, ActivitySingleTask.class);
                MainActivity.this.startActivity(singleTaskIntent);
                break;
        }
    }
